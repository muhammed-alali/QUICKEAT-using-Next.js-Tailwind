          ...
          <div className="grid grid-cols-12">
            ...
            <div className=" col-span-4 py-9 px-20">
              ...
              <ul className="text-[#CFCFCF] py-8 ">
                <li className="py-2 text-lg hover:text-color1 duration-300"> <a href="" className="flex">Home        <GrFormNextLink  className=" text-2xl font-bold mx-2 my-[2.5px]"/></a> </li>
                <li className="py-2 text-lg hover:text-color1 duration-300"> <a href="" className="flex">About Us    <GrFormNextLink  className=" text-2xl font-bold mx-2 my-[2.5px]"/></a></li>
                <li className="py-2 text-lg hover:text-color1 duration-300"> <a href="" className="flex">Restaurants <GrFormNextLink  className=" text-2xl font-bold mx-2 my-[2.5px]"/></a></li>
                <li className="py-2 text-lg hover:text-color1 duration-300"> <a href="" className="flex">Contacts    <GrFormNextLink  className=" text-2xl font-bold mx-2 my-[2.5px]"/></a> </li>
              </ul>
            </div>
            <div className=" col-span-4 py-9 px-20">
              <h2 className="text-3xl uppercase font-bold text-color2">
              ...
              <div className="flex gap-6 text-xl py-5 px-5 text-[#CFCFCF]">
                  <h5 className=" border hover:bg-color2 hover:text-white duration-[0.5s] py-2 px-2 rounded-full"><FaFacebookF /></h5>
                  <h5 className=" border hover:bg-color2 hover:text-white duration-[0.5s] py-2 px-2 rounded-full"><FaInstagram /></h5>
                  <h5 className=" border hover:bg-color2 hover:text-white duration-[0.5s] py-2 px-2 rounded-full"><FaTwitter /></h5>
              </div>
            </div>
        </div>
